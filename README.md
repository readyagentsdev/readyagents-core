...
Requires **Python 3.11–3.14** on Linux, macOS, or Windows. Current version is **2.0.5**. Install with `pip install readyagentsdev`, or from this clone. The `2` versions the [core contract](docs/stability.md#what-the-version-number-means) only; extras carry their own maturity tiers.
...
- [Release notes 2.0.5](RELEASE_NOTES.md)
