"""Byte-identical no-`type: team` guard for V2-01. Written before the node lands."""
...
def test_calc_pipeline_without_team_json_keys() -> None:
    first = runner.invoke(
...
def test_approval_gate_without_team_still_pauses(tmp_path: Path, monkeypatch) -> None:
...
def test_parallel_and_foreach_still_exist() -> None:
