"""Byte-identical no-registry guard for V2-24. Written before the registry lands."""
...
def test_calc_pipeline_without_registry_json_keys() -> None:
    first = runner.invoke(
...
def test_eval_pass_without_registry() -> None:
