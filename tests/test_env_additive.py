"""Byte-identical no-env guard for V2-21. Written before environments land."""
...
def test_calc_pipeline_without_env_json_keys() -> None:
    first = runner.invoke(
...
def test_eval_pass_without_env() -> None:
