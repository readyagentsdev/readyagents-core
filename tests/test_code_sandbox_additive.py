"""Byte-identical no-`code`-node guard for V2-02. Written before the node lands."""
...
def test_calc_pipeline_without_code_node_json_keys() -> None:
    first = runner.invoke(
...
def test_approval_gate_without_code_node_still_pauses(tmp_path: Path, monkeypatch) -> None:
