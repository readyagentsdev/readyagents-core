...
No API keys. Current version is **2.0.10** (`readyagents version`). Install from PyPI
...
## Optional (2.0.10 surface)

**2.0.10** includes connectors, sovereign, memory, and A2A. Keyless examples
