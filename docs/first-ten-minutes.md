...
No API keys. Current version is **2.0.9** (`readyagents version`). Install from PyPI
...
## Optional (2.0.9 surface)

**2.0.9** includes connectors, sovereign, memory, and A2A. Keyless examples
